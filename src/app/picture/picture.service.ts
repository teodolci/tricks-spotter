...
import { QimgImage } from '../models/Qimg-response';
...
export class PictureService {
   ...
   */
  public takeAndUploadPicture(): Observable<QimgImage> {
    // Take a picture.
   ...
   */
  public uploadPicture(base64: string | ArrayBuffer): Observable<QimgImage> {
    const requestBody = {
      data: base64,
    };
